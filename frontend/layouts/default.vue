<template>
  <div class="flex min-h-screen bg-[#F5F5F7] text-[#1a1c1c]">
    <!-- Sidebar -->
    <aside class="fixed left-0 top-0 h-screen w-[280px] bg-[rgba(249,249,249,0.8)] backdrop-blur-3xl border-r border-white/20 shadow-[0px_4px_20px_rgba(0,0,0,0.04)] flex flex-col p-gutter z-50">
      <!-- Brand -->
      <div class="mb-xl flex items-center gap-md">
        <div class="w-10 h-10 bg-[#0070eb] rounded-xl flex items-center justify-center shadow-md">
          <span class="material-symbols-outlined text-white text-[22px]" style="font-variation-settings:'FILL' 1">hub</span>
        </div>
        <div>
          <h1 class="text-[#0058bc] font-bold tracking-tight" style="font-size:20px;line-height:28px">WA Control</h1>
    ...
    <!-- Main content area -->
    <div class="ml-[280px] flex flex-col min-h-screen flex-1">
      <!-- Top navigation bar -->
      <header class="sticky top-0 h-16 flex justify-between items-center px-gutter bg-[rgba(249,249,249,0.6)] backdrop-blur-md border-b border-[rgba(193,198,215,0.1)] z-40">
        <div class="relative w-full max-w-md">
          ...
          <input
            ...
            placeholder="Search logs, devices, or webhooks..."
            type="text"
          />
        </div>
        <div class="flex items-center gap-md ml-lg">
          <button class="p-sm text-[#414755] hover:text-[#0058bc] transition-colors">
            <span class="material-symbols-outlined">notifications</span>
          </button>
          <button class="p-sm text-[#414755] hover:text-[#0058bc] transition-colors">
            <span class="material-symbols-outlined">help_outline</span>
          </button>
          <div class="h-8 w-px bg-[rgba(193,198,215,0.3)]"></div>
          <div class="flex items-center gap-sm cursor-pointer hover:opacity-80 transition-opacity" @click="logout">
            <div class="w-8 h-8 rounded-full bg-[#0058bc] flex items-center justify-center text-white font-bold text-[13px]">A</div>
            <span class="text-[13px] font-semibold text-[#1a1c1c]">Admin</span>
      ...
      <!-- Page content -->
      <main class="flex-1 p-container-margin max-w-[1440px]">
        <slot />
      </main>
    </div>
  </div>
